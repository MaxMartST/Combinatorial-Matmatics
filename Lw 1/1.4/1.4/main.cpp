...
void MyClass::GetCombination()
{
	...
	while (m != 0)
	{
		//copy(сombination.begin() + 1, сombination.end(), std::ostream_iterator<int>(std::cout, " "));
		//std::cout << "\n";
...
void MyClass::PrintParam()
{
	std::cout << elementsCombination << std::endl;
	std::cout << numberElements << std::endl;
}
